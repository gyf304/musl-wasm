#define __MAIN_0_ARGS()                            main(int, char **, char **)
#define __MAIN_1_ARGS(argc)                        main(argc, char **, char **)
#define __MAIN_2_ARGS(argc, argv)                  main(argc, argv, char **)
#define __MAIN_3_ARGS(argc, argv, envp)            main(argc, argv, envp)
